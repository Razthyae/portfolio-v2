    ...
    return (
        ...
        >
            ...
            <div className='contactWrapper'>
                <div className="phone cta contact1">Call me</div>
                <div className="phone number">+48 796 453 528</div>
            </div>

            <a href='https://m.me/ZealDJ'>
                <div className='contactWrapper'>
                    <div className="phone cta contact2">Messenger</div>
            ...
            <a href='mailto:a_kumar@poczta.fm'>
                <div className='contactWrapper'>
                    <div className="phone cta contact3">Mail</div>
            ...
            <a href='https://razthyae.github.io/'>
                <div className='contactWrapper'>
                    <div className="phone cta contact4">GitHub</div>
